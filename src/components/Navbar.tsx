          ...
          <div className="hidden xl:flex items-center space-x-1 shrink-0">
            ...
            <div className="flex items-center gap-2 pl-3 ml-1 border-l border-white/20">
              ...
              <button
                ...
                className="px-4 py-2 bg-red-600 hover:bg-red-500 text-white font-black text-xs sm:text-sm rounded-full shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-0.5 cursor-pointer whitespace-nowrap ring-2 ring-red-300 ring-offset-2 ring-offset-[#0B3D5E]"
              >
                Daftar Sekarang
              </button>
            </div>
        ...
        <div id="mobile-nav-drawer" className="xl:hidden bg-[#0B3D5E] border-t border-white/10 shadow-xl px-3 pt-3 pb-5 space-y-1.5">
          <div className="grid grid-cols-2 gap-2 pb-2.5 mb-2 border-b border-white/15">
            ...
            <button
              ...
              className="w-full py-2.5 bg-red-600 text-white hover:bg-red-500 font-black text-sm rounded-lg text-center shadow-md ring-2 ring-red-300"
            >
              Daftar Sekarang
            </button>
          </div>
